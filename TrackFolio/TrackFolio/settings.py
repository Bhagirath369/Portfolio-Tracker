"""
Django settings for TrackFolio project.
...
SECRET_KEY = "django-insecure-g7+%tqxvf*6fq-n0gwhp4h%@z0^z78%ce@-1a)a7$4@k$5=uif"
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'roshan123',   # The password you set for PostgreSQL user
